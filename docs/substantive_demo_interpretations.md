...
TRIM's comparison software generates structural observations and prompts. It
does not generate humanities claims. The interpretations below are
researcher-authored worked demonstrations based on the checked fields in
`data/demo_annotations.csv`. They illustrate possible analytic payoff; they are
not universal findings about the works or traditions.
...
The following prose is a separate human-curated layer.
...
Liao's interpretation grants the Yi-related result warranting force and
projects that force into prospective lineage significance. The shared function
label therefore contains a distinction between procedural stabilization and
...
commentarial layers. The first pathway extends deliberation horizontally
through competing warrants; the second extends significance vertically through
...
remains responsible for the substantive interpretation, textual adequacy, and
scope of any claim.
