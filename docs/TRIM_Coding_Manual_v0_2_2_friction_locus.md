# TRIM Coding Manual v0.2.2: `friction_locus`
...
v0.2.2 revises the v0.2.0 manual only where the locked pilot and adjudication
showed instability.
...
v0.2.2 source packets should make scope explicit, so this value should not be
