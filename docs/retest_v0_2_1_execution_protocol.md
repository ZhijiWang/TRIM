# TRIM v0.2.1 Retest Execution Protocol

This protocol governs execution after the v0.2.1 coder package has been frozen and distributed. It does not change the empirical design, codebook, schema, source packet, or case selection.
...
4. Complete the question log and language-access form.
