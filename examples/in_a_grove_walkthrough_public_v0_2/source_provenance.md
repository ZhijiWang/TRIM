...
The Japanese text in `source_segments_japanese.csv` is the formal evidence layer. The English gloss is versioned separately and is non-authoritative. All annotation records must cite Japanese segment IDs.
...
The earlier Kojima-based walkthrough remains a restricted development artifact. Its segmentation, author record, AI record, and findings are not carried forward into this version.
