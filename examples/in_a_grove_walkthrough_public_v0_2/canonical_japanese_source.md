...
The formal evidence for this walkthrough is the Japanese text in `source_segments_japanese.csv`.

- Author: 芥川龍之介 (Akutagawa Ryūnosuke)
- Work: 「藪の中」 (*Yabu no Naka*)
...
Only Japanese segment IDs are formal evidence anchors. The English gloss is an accessibility aid and is not an independent evidential source.

## Scope

This packet begins when the wife runs into the grove and ends when the dead samurai says that he sank forever into the darkness of *chūu*. Earlier parts of the testimony and all other testimonies are outside the packet.
