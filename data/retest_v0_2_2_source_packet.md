# TRIM v0.2.2 Retest Source Packet
...
permitted case scope.

All formal coding must be possible from this supplied packet. External links in
the manifest are provenance references and are not required for completion. This
packet contains no expected labels.

Each formal segment provides verified public-domain source text or verified
public-domain translation text. Navigation notes identify location, speaker, or
...
Navigation note: Caesar speaks at the opening of Act 2, Scene 2, before the
servant enters.

#### `JC_CALPURNIA_DECIUS_S2`
...
Navigation note: Caesar gives the servant an instruction in Act 2, Scene 2.

#### `JC_CALPURNIA_DECIUS_S3`
...
Navigation note: The servant returns after Calpurnia and Caesar have spoken.

#### `JC_CALPURNIA_DECIUS_S4`
...
Navigation note: Caesar reports Calpurnia's dream to Decius in Act 2, Scene 2.

#### `JC_CALPURNIA_DECIUS_S5`
...
Navigation note: Decius answers Caesar's report of Calpurnia's dream in Act 2,
Scene 2.
...
Navigation note: The exchange occurs in the public place in Act 1, Scene 2.

#### `JC_IDES_SOOTHSAYER_S2`
...
Navigation note: Caesar asks to see the speaker and hears the sentence repeated.

#### `JC_IDES_SOOTHSAYER_S3`
...
Navigation note: Caesar speaks after the repeated warning in Act 1, Scene 2.
...
Navigation note: The Ghost identifies itself to Hamlet in Act 1, Scene 5.

#### `HAM_GHOST_COMMAND_S2`
...
Navigation note: The Ghost speaks after commanding Hamlet to listen.

#### `HAM_GHOST_COMMAND_S3`
...
Navigation note: The exchange appears early in the Ghost's account.

#### `HAM_GHOST_COMMAND_S4`
...
Navigation note: Hamlet speaks after the Ghost exits in Act 1, Scene 5.
...
Navigation note: Hamlet addresses Horatio before the court watches the play.

#### `HAM_PLAY_REACTION_S2`
...
> two or three Mutes, comes in again, seeming to lament with her. The dead body
...
Navigation note: This stage direction is the dumb-show in Act 3, Scene 2.

#### `HAM_PLAY_REACTION_S3`
...
Navigation note: This excerpt begins with Lucianus in the play and ends as the
court breaks off the performance.

#### `HAM_PLAY_REACTION_S4`
...
Navigation note: Hamlet and Horatio speak after the court exits.
...
**Scope:** multi-passage single case  
**Text basis:** MIT Shakespeare electronic text

#### `OTH_HANDKERCHIEF_CHAIN_S1`
...
Navigation note: This excerpt is from Act 3, Scene 3.

#### `OTH_HANDKERCHIEF_CHAIN_S2`
...
Navigation note: This excerpt follows the dropped handkerchief in Act 3,
Scene 3.

#### `OTH_HANDKERCHIEF_CHAIN_S3`
...
Navigation note: Iago speaks to Othello later in Act 3, Scene 3.

#### `OTH_HANDKERCHIEF_CHAIN_S4`
...
Navigation note: This exchange is from Act 3, Scene 4.

#### `OTH_HANDKERCHIEF_CHAIN_S5`
...
Navigation note: Bianca enters with the handkerchief in Act 3, Scene 4.
...
Navigation note: The guard reports to Creon after entering.
...
Navigation note: The guard continues the report to Creon.
...
Navigation note: The guard describes the sentries after the burial was found.
...
Navigation note: Creon speaks after the guard and the chorus.
...
Navigation note: Teiresias speaks to Creon after entering with the boy.

#### `ANT_TEIRESIAS_OMENS_S2`
...
> Could signify naught else.

Navigation note: This sentence follows Teiresias's account of the bird sounds.

#### `ANT_TEIRESIAS_OMENS_S3`
...
Navigation note: This passage follows the bird-sign passage in Teiresias's
speech.

#### `ANT_TEIRESIAS_OMENS_S4`
...
Navigation note: Teiresias addresses Creon in the same speech.
...
Navigation note: Oedipus addresses Teiresias after Teiresias enters.

#### `OED_TIREISIAS_ACCUSATION_S2`
...
Navigation note: Teiresias answers Oedipus before the accusation.

#### `OED_TIREISIAS_ACCUSATION_S3`
...
Navigation note: Teiresias speaks after Oedipus accuses him of involvement.

#### `OED_TIREISIAS_ACCUSATION_S4`
...
Navigation note: Teiresias repeats the charge in the same exchange.
...
Navigation note: The Corinthian messenger speaks with Oedipus after reporting
Polybus's death.

#### `OED_MESSENGER_SHEPHERD_S2`
...
Navigation note: The messenger continues the account of Oedipus's infancy.

#### `OED_MESSENGER_SHEPHERD_S3`
...
Navigation note: The herdsman has entered and is being questioned.

#### `OED_MESSENGER_SHEPHERD_S4`
...
Navigation note: Oedipus questions the herdsman near the end of the exchange.

#### `OED_MESSENGER_SHEPHERD_S5`
...
Navigation note: The herdsman and Oedipus speak at the end of the recognition
exchange.
...
Navigation note: Socrates speaks about Chaerephon during his defense.

#### `APOL_ORACLE_INQUIRY_S2`

Source text:

> When I heard the answer, I said to myself, What can the god mean? and what is
> the interpretation of his riddle? for I know that I have no wisdom, small or
> great. What then can he mean when he says that I am the wisest of men? And yet
> he is a god, and cannot lie; that would be against his nature.

Navigation note: Socrates continues after quoting the oracle's answer.

#### `APOL_ORACLE_INQUIRY_S3`

Source text:

> After long consideration, I thought of a method of trying the question. I
> reflected that if I could only find a man wiser than myself, then I might go
...
> went to one who had the reputation of wisdom, and observed him--his name I
...
Navigation note: Socrates describes the first inquiry he undertook after the
oracle report.

#### `APOL_ORACLE_INQUIRY_S4`
...
> neither know nor think that I know. In this latter particular, then, I seem
> to have slightly the advantage of him.

Navigation note: Socrates describes his conclusion after speaking with the
politician.
...
Navigation note: Inspector Gregory and Holmes speak during the carriage scene.
...
Navigation note: Holmes answers Inspector Gregory.
...
Navigation note: Gregory and Holmes continue the same exchange.

---

## `AESOP_FOX_GRAPES`

**Source:** "The Fox and the Grapes" in *Three Hundred Aesop's Fables*, translated by George Fyler Townsend  
**Scope:** local passage only  
...
Navigation note: This sentence opens "The Fox and the Grapes."
...
Navigation note: This sentence follows the opening sentence.

#### `AESOP_FOX_GRAPES_S3`

Source text:

> At last she turned away, hiding her disappointment and saying: "The Grapes
> are sour, and not ripe as I thought."

Navigation note: This sentence closes the fable.
